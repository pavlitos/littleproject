...
public class ViewClients extends JFrame {
    ...
    public ViewClients(Controller controller) {
    ...
    private void View() {
        ...
        clientsLabel.setBounds(47, 157, 70, 15);
        ...
        panel.add(eventList);
        eventList.setBounds(138, 156, 271, 167);
    ...
    public void addListMouseListener(JList list) {
        list.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ...
                clientPhoneField.setText(Integer.toString((client.getAge())));
            }
